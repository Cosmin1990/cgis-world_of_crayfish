...
const MapComponent = React.memo(({ latitude, longitude, points, AOOObject, BasinObject, EOOObject }: MapComponentProps) => {
    ...
    <>
      ...
      <LayersControl position="topright">
          ...
          <LayersControl.Overlay checked={false} name="AOO Layer (string)">
              {/* <GeoJSON  data={AOOObject!}  style={{color: "#FFFF00", weight: 2, fillColor: "#FFFF00",fillOpacity: 0.2,}}/> */}
              <GeoJSON
          ...
          <LayersControl.Overlay checked={false} name="EOO Layer (string)">
              ...
              />
              {/* <GeoJSON  data={EOOObject!}  style={{color: "#001effff", weight: 2, fillColor: "#001effff",fillOpacity: 0.2,}}/> */}
          </LayersControl.Overlay>
      </LayersControl>
